 ...
 * */
xx_grid* xx_create_grid ( int screen_width, int screen_height, int total_number_of_units ); // creating the xx_grid pointer nad returns it
 ...
 * */
xx_grid* xx_create_grid ( int screen_width, int screen_height, int total_number_of_units ) {
  ...
  r_grid -> unit_info = (xx_grid_unit_info*) calloc (r_grid -> max_unit_n, sizeof(xx_grid_unit_info));
  ...
  for ( int i = 0; i < r_grid -> max_unit_n; i++ ) {
    r_grid -> row_info [i].store_index = (int*) calloc (r_grid -> max_unit_n, sizeof(int));
...
void xx_print_grid_info ( xx_grid* i_grid ) {
  ...
  int result = 0;
  result += sizeof(xx_grid) + i_grid -> max_unit_n * sizeof(xx_grid_row_info) + ( i_grid -> max_unit_n * sizeof(xx_grid_unit_info) 
      + (sizeof(int) * i_grid -> max_unit_n) * i_grid -> max_unit_n
      );
